...
// Input/output files
#define FILE_GRID  "../../22-12_grid/10th_deg_grid.nc"
#define FILE_TIDES "../TPXO.nc"
#define FILE_WIND  "../198710.nc"
#define FILE_OUT   "out"
...
#define NYW 360                   // This must be an integer

// Time steps
#define DT (12.42*3600/50)        // Forward model time step [sec]
...
#define DT_F (12*3600)            // Wind forcing interval
...
#define R    (1.0/(4*24*3600))   // Constant linear "Rayleigh" damping (or minimum value)
...
#define NO_ANTARCTIC              // No tidal forcing, topographic coupling, or fancy damping south of 60 S
